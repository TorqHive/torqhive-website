...
export default function ProductDetailPage() {
  ...
  const waText = encodeURIComponent(`Hi TorqHive, I'd like to inquire about ${product.id} — ${product.title}. Please share availability and pricing.`);
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '64px', alignItems: 'start' }} className="pdp-grid">
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '12px', marginTop: '16px' }}>
              <a href={waUrl} target="_blank" rel="noopener noreferrer" className="btn btn-primary" style={{ flex: 1, justifyContent: 'center', gap: '8px' }}>
