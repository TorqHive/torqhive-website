...
const WA_URL = 'https://wa.me/8615669586372?text=Hi%20TorqHive%2C%20I%27d%20like%20to%20discuss%20a%20product%20inquiry.';
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: '80px', alignItems: 'start' }} className="contact-grid">
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
                <div>
                  <p className="text-meta" style={{ marginBottom: '8px' }}>WhatsApp Business</p>
                  <a
                    href={WA_URL}
                    target="_blank"
                  ...
                  <p style={{ fontSize: 'var(--text-xs)', color: 'var(--th-muted)', marginTop: '8px' }}>Opens WhatsApp — fastest way to get a reply.</p>
                </div>
